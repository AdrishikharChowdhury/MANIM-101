...
class Chips_Admin_Intro(Scene):
    def construct(self):
        ...
        bklit_group = GroupTextImage("./assets/bklit.svg", "BK Lit")
        lottie_group = GroupTextImage("./assets/lottie.svg", "Lottie")
        stack_group = VGroup(bklit_group, lottie_group).scale(0.6)
        stack_group.arrange(RIGHT, buff=1)
        ...
        footnote1 = Text("Developer's Journey", weight=LIGHT).scale(0.5)
        footnote2 = Text("Stage: Admin Panel", weight=LIGHT).scale(0.5).next_to(footnote1, DOWN, buff=0.2)
